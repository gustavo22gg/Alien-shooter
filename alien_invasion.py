...
class AlienInvasion:
    ...
    def _start_game(self):
        ...
        self.aliens.empty()
        self.bullets.empty()
        # Create a new fleet and reset ship
        self._create_fleet()
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Reset fleet when all destroyed
        if not self.aliens:
            self.bullets.empty()
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        # Make a row of aliens.
        # Spacign between each alien is equal to one alien width
        alien = Alien(self)
    ...
    def _check_fleet_edges(self):
        """Respond if any alien hits the edge"""
